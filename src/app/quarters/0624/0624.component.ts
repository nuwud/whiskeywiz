// 0624.component.ts
/** 
 * Whiskey Wiz Quarter Component - Q2 2024 
 * 
 * Integration:
 * <whiskey-wiz-0624></whiskey-wiz-0624> 
 */
...
@Component({
  selector: 'app-quarter-0624',
  template: `
    <app-game-banner 
      [quarterId]="quarterId"
      [quarterName]="quarterName || 'June 2024'">
    </app-game-banner>

    <div *ngIf="!quarterData">Loading...</div>
    <div *ngIf="quarterData">
      <h2>{{ quarterData?.name || 'June 2024' }}</h2>
...
export class Q0624Component extends BaseQuarterComponent {
  @Input() override quarterId: string = '0624';  // Add override since it's in base component
  @Input() quarterName: string = 'June 2024';
