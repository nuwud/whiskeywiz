// 0326.component.ts
/** 
 * Whiskey Wiz Quarter Component - Q1 2026 
 * 
 * Integration:
 * <whiskey-wiz-0326></whiskey-wiz-0326> 
 */
...
@Component({
  selector: 'app-quarter-0326',
  template: `
      <app-game-banner 
      [quarterId]="quarterId"
      [quarterName]="quarterName || 'March 2026'">
    </app-game-banner>
    <div *ngIf="!quarterData">Loading...</div>
    <div *ngIf="quarterData">
      <h2>{{ quarterData?.name || 'March 2026' }}</h2>
...
export class Q0326Component extends BaseQuarterComponent {
  @Input() override quarterId: string = '0326';  // Add override since it's in base component
  @Input() quarterName: string = 'March 2026';
